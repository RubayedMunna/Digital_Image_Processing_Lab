...
Image.fromarray(np.uint8(resized_image_linear)).save('linear_interpolation_resized_purple.jpg')
Image.fromarray(np.uint8(resized_image_pixel_skip)).save('pixel_skipping_resized_purple.jpg')
Image.fromarray(np.uint8(resized_image_replicate)).save('replication_resized_purple.jpg')
