...
def replicate_resize(image_array, new_width, new_height):
    ...
    Returns:
    numpy.ndarray: Resized image array using replication.
    """
...
# Resize the image using the replication method
resized_image_array = replicate_resize(image_array, new_width, new_height)

# Convert the result back to an image
resized_image = Image.fromarray(resized_image_array)

# Save the result
output_path = 'replication_resized_purple.jpg'
