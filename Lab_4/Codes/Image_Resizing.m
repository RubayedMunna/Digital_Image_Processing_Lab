...
% Display resized image using replication (nearest neighbor)
subplot(2, 2, 2);
imshow(resizedImageReplication);
title('Resized Image (Replication)');

% Display resized image using linear interpolation
subplot(2, 2, 3);
imshow(resizedImageLinear);
title('Resized Image (Linear Interpolation)');

% Display resized image using pixel skipping method
subplot(2, 2, 4);
